...
<Tabs items={['pnpm', 'npm', 'yarn', 'bun']}>
  <Tab>
    ```bash
    pnpm install -D @mfauzanap_pandacss/dev @mfauzanap_pandacss/astro
    pnpm panda init
    ```
  </Tab>
  <Tab>
    ```bash
    npm install -D @mfauzanap_pandacss/dev @mfauzanap_pandacss/astro
    npx panda init
    ```
  </Tab>
  <Tab>
    ```bash
    yarn add -D @mfauzanap_pandacss/dev @mfauzanap_pandacss/astro
    yarn panda init
    ```
  </Tab>
  <Tab>
    ```bash
    bun add -D @mfauzanap_pandacss/dev @mfauzanap_pandacss/astro
    bun panda init
    ```
  </Tab>
</Tabs>
